...
import { useGetBakoziOauthURLQuery, useLoginMutation, useOauthLoginMutation } from '../features/auth/authApiSlice';
...
const Login = () => {
  ...
  const { isLoading: isbakoziURLLoading, data, isError } = useGetBakoziOauthURLQuery();
